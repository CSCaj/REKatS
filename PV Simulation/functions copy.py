...
def berechnung_durchfuehren(entries, checkbox_vars):
    try:
        ...
        # PV-System mit ausgewählten Arrays erstellen
        system = PVSystem(arrays=arrays, inverter_parameters=wechselrichter_parameter)
        ...
        # # Montagesysteme definieren für Ost- und Westausrichtung
        # mount_dach_ost = c.DACH_OST_SG30
        # mount_dach_west = c.DACH_WEST_SG30
        # mount_seite_ost = c.SEITE_OST_SG30
        # mount_seite_west = c.SEITE_WEST_SG30
        ...
        # # PV-System mit Arrays erstellen
        # system = PVSystem(arrays=[array_dach_ost, array_dach_west, array_seite_ost, array_seite_west], inverter_parameters=wechselrichter_parameter)
        ...
        #               modules_per_string=c.DACH_SG30_MPS, 
        #               strings=c.DACH_SG30_STRINGS
        #               )
